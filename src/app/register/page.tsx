  ...
  return (
    <section className="mx-auto max-w-md px-4 py-16">
      ...
      <form onSubmit={submit} className="space-y-3 rounded-2xl border border-slate-800 bg-slate-950 p-6">
        <input className="w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2" placeholder="Name" value={name} onChange={(e) => setName(e.target.value)} />
        ...
        <button className="w-full rounded-lg bg-[#2563EB] py-2 font-semibold">Register</button>
      </form>
    </section>
  );
}
